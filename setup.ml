...
(* OASIS_START *)
(* DO NOT EDIT (digest: 99ae6d295c149fa6a549c8a5f5bb4251) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cohttp",
                               Some (OASISVersion.VGreaterEqual "0.21.0"));
                           ...
                           FindlibPackage
                             ("fieldslib",
                               Some (OASISVersion.VGreaterEqual "113.0.0"));
                   ...
                   {
                      lib_modules = ["Swt"; "Auth"];
                      lib_pack = false;
                      lib_internal_modules = ["Route_tree"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\127/\150\t\207k\219\140m\025\227\197\145\239Zc";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
